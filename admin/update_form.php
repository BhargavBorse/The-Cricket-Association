            ...
            <div class="col-lg-6">
                ...
                <span style="background-color: rgba(34, 31, 32, 0.87); color: white;">
                    <form action="update_form.php" method="POST" style="padding: 50px; background-color: rgba(34, 31, 32, 0.87); color: white;">
                        ...
                        <a href="sql/update_prof.php?username=<?php echo $d['username'] ?>" class="btn btn-primary stretched-link">Change</a>
                        <br><br>
                        <label>Phone Number</label>
                        <input type="number" class="form-control" name="number"><br>
                        <a href="sql/update_prof.php" class="btn btn-primary stretched-link">Change</a>
                        <br><br>
                        <label>Email</label>
