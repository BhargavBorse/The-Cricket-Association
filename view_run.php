...
<head>
    ...
    <style>
        body{
            background-image: url(craig.jpg);
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger fixed-top" id="thenav" >
        ...
        <div class="collapse navbar-collapse" style="margin-left: 5%;" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="view_run.php">View Run Stats</a>
                </li>
                <li class="nav-item">
        ...
        <div class="col-lg-2"></div>
            <div class="col-lg-8">
                <div class="d-flex justify-content-center">
                    <h1 style="color: white;">Run's Scored in Past Tournaments</h1>
                </div>
    ...
    <div class="row">
        <div class="container">
            <div class="col-lg-12">
            <a href="index1.php" class="btn btn-danger my-2 my-sm-0">Print / Generate PDF</a>
                        ...
                        <div class="card-body table-responsive table-hover" id="printableArea">
                            <table class="table">
                                ...
                                <?php
                                    ...
                                    // echo $sd;
                                    $fetch = "SELECT * FROM player_bat_det WHERE player_name = '$sd'";
