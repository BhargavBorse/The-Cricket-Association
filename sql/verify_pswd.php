<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $q1 = "SELECT * FROM req_details WHERE username = '$username' and password = '$old_password'";
        ...
        if(mysqli_num_rows($r1) > 0)
        {
            ...
            {
                $del="UPDATE req_details SET password = '$new_password' WHERE player_name = '$player_name'";
