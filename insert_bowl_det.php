...
<head>
    ...
    <style>
        body{
            background-image: url(alessandro.jpg);
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger fixed-top" id="thenav" >
        ...
        <div class="collapse navbar-collapse" style="margin-left: 5%;" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active">Enter Bowling Stats</a>
                </li>
                <li class="nav-item">
        ...
        <div class="col-lg-2"></div>
            <div class="col-lg-8">
                ...
                <span style="background-color: rgba(34, 31, 32, 0.87); color: white;">
                    <form action="sql/insert_bowl.php" method="POST" style="padding: 50px; background-color: rgba(34, 31, 32, 0.87); color: white;">
