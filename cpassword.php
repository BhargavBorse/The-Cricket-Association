        ...
        <div class="col-lg-2"></div>
            <div class="col-lg-8">
                ...
                <span style="background-color: rgba(34, 31, 32, 0.87); color: white;">
                    <form action="sql/verify_pswd.php" method="POST" style="padding: 50px; background-color: rgba(34, 31, 32, 0.87); color: white;">
                        ...
                        <br>
                        <input type="submit" name="submit" value="VERIFY" class="btn btn-block btn-outline-info">  
